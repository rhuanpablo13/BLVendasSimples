 ...
 * @author rhuan
 */
public class CRMedida extends CadastroRapido {

    private String operacao = Operacao.CADASTRO.name();
    ...
    public void init() {
        ...
        // nome
        jTableListagem.getColumnModel().getColumn(2).setPreferredWidth(140);
    }
    ...
    protected void cadastrar() {
        ...
        if (operacao.equals(Operacao.ALTERAR)) {
            try {
                ...
                new Sucess("Medida alterado com sucesso!", "Cadastro Rápido de Medida").show();
            } catch (Exception e) {
                showException(e);
            }
            ...
            try {
                ...
                new Sucess("Medida cadastrada com sucesso!", "Cadastro Rápido de Medida").show();
            } catch (Exception e) {
                showException(e);
            }
        }
        ...
        operacao = Operacao.CADASTRO.name();
    }    
    
    
    protected void pesquisar() {
        
        operacao = Operacao.PESQUISAR.name();
        NMedida medida = new NMedida();
        try {
    ...
    protected void editar() {
        ...
        operacao = Operacao.ALTERAR.name();
        int row = jTableListagem.getSelectedRow();
        if (row > -1) {
